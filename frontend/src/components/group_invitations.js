...
//         try {
//             const response = await fetch(`http://${process.env.NEXT_PUBLIC_GOSERVER}/api/group/invitations/info`, {
//                 headers: {
...
//                 body: formData
//             });
//             console.log("this is the form data for group invitation", action , groupId)
